...
public class KuMaoRemoteDataSource implements KuMaoDataSource {
    ...
    public Observable<SongListArray> getSongListArrary(String url, Map<String, String> maps) {
        return createObservable(url, maps, ParserFactory.PARSE_SONG_LIST_ARRARY, 12 * ACache.TIME_HOUR);
    }

    @Override
    public Observable<SongList> getSongList(String url, Map<String, String> maps) {
        return createObservable(url, maps, ParserFactory.PARSE_SONG_LIST_INFO, 12 * ACache.TIME_HOUR);
    }
