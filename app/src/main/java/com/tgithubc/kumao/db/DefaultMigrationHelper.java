...
import static com.tgithubc.kumao.BuildConfig.DEBUG;

public final class DefaultMigrationHelper {

    private static String TAG = "DefaultMigrationHelper";
    ...
    private static void generateTempTables(Database db, Class<? extends AbstractDao<?, ?>>... daoClasses) {
        for (Class<? extends AbstractDao<?, ?>> daoClass : daoClasses) {
            ...
            try {
                ...
                if (!mTableNames.contains(daoConfig.tablename)) {//如果数据库中没有该表，则继续下次循环
                    continue;
                }
